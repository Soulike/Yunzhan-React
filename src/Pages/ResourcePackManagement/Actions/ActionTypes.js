...
export const RESOURCE_PACK_SELECT_TAGS = Symbol('resourcePackSelectTags');
...
export const RESOURCE_PACK_SELECT_ADVERTISEMENTS = Symbol('resourcePackSelectAdvertisements');
